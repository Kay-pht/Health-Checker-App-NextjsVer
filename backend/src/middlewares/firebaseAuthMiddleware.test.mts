...
describe("firebaseAuthMiddleware for error cases", () => {
  ...
  // TODO:failure with expired token
...
//   let testInstance: typeof firebaseAuthMiddleware;
...
//     testInstance = new firebaseAuthMiddleware(req, res, next);
//   });
...
//     const result = await testInstance.firebaseAuthMiddleware(payload);
