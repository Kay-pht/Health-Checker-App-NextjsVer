...
describe("getChatCompletion with invalid API key", () => {
    ...
    it("should throw an error due to the invalid key", () => __awaiter(void 0, void 0, void 0, function* () {
        process.env.OPENAI_API_KEY = "invalid_key";
        const { getChatCompletion } = yield import("./openAI.mjs");
        yield expect(getChatCompletion(orderedAnswers)).rejects.toThrow("Failed to connect to OpenAI: 401 Incorrect API key provided: invalid_key. You can find your API key at https://platform.openai.com/account/api-keys.");
    }));
});
...
describe("getChatCompletion", () => {
    ...
    //   );
    // });
    it("should return an intended response with mock function", () => __awaiter(void 0, void 0, void 0, function* () {
        // TODO: write test case
    }));
});
// describe("getChatCompletion", () => {
