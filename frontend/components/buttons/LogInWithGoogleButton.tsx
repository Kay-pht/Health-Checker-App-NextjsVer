...
const LogInWithGoogleButton = ({ register }: registerProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center flex-row flex-nowrap h-full justify-center relative w-full">
        <div className="h-5  min-w-5 w-5 ml-3">
          <svg
            version="1.1"
        ...
        <span className="flex-grow font-bold overflow-hidden truncate align-top text-center mr-5">
